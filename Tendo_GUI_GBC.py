...
#
# -*- coding: utf-8 -*-
#The software requires the following packages: Python 3.7.7, PyQt5 5.11.3, NumPy 1.21.6, MinimalModbus 2.0.1, and PyQtGraph 0.10.0
"""

This code was written by benali abderrahmanne 

This Python script enables the creation of a user-friendly graphical interface for data acquisition and visualization.
It leverages PyQtGraph library for data plotting and MinimalModbus library for Modbus protocol-based communication with devices over serial ports.
Through the GUI controls,users can initiate data acquisition, modify Modbus register values.
Real-time plotting on a graph displays some of the acquired data.
"""
import argparse
...
from PyQt5.QtWidgets import  QStackedWidget, QMessageBox, QApplication
...
instr = None #minimalmodbus.Instrument(args.port, args.adr)
...
class Ui_gui(object):
    ...
    def setupUi(self, gui):
        ...
        self.AutoCalibrateButton.setGeometry(QtCore.QRect(350, 402, 151, 71))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.WriteFlashButton.setGeometry(QtCore.QRect(170, 402, 161, 71))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.DAQSETTINGS_tableWidget.setGeometry(QtCore.QRect(0, 78, 202, 174))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        font.setWeight(75)
        ...
        self.DAQSETTINGS_tableWidget.horizontalHeader().setMinimumSectionSize(80)
        self.DAQSETTINGS_tableWidget.horizontalHeader().setMaximumSectionSize(80)
        ...
        self.DAQSETTINGS_tableWidget.verticalHeader().setMinimumSectionSize(34)
        self.DAQSETTINGS_tableWidget.verticalHeader().setMaximumSectionSize(34)
        
        self.FLUIDCALIBRATION_tableWidget = QtWidgets.QTableWidget(self.SettingsPage)
        self.FLUIDCALIBRATION_tableWidget.setGeometry(QtCore.QRect(200, 78, 202, 311))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.FLUIDCALIBRATION_tableWidget.horizontalHeader().setMinimumSectionSize(80)
        self.FLUIDCALIBRATION_tableWidget.horizontalHeader().setMaximumSectionSize(80)
        ...
        self.FLUIDCALIBRATION_tableWidget.verticalHeader().setMinimumSectionSize(34)
        self.FLUIDCALIBRATION_tableWidget.verticalHeader().setMaximumSectionSize(34)
        self.POURSETTINGS_tableWidget = QtWidgets.QTableWidget(self.SettingsPage)
        self.POURSETTINGS_tableWidget.setGeometry(QtCore.QRect(400, 78, 202, 208))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.POURSETTINGS_tableWidget.horizontalHeader().setMinimumSectionSize(80)
        self.POURSETTINGS_tableWidget.horizontalHeader().setMaximumSectionSize(80)
        ...
        self.POURSETTINGS_tableWidget.verticalHeader().setMinimumSectionSize(34)
        self.POURSETTINGS_tableWidget.verticalHeader().setMaximumSectionSize(34)
        self.STATUS_tableWidget = QtWidgets.QTableWidget(self.SettingsPage)
        self.STATUS_tableWidget.setGeometry(QtCore.QRect(600, 78, 190, 402))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.STATUS_tableWidget.horizontalHeader().setMinimumSectionSize(87)
        self.STATUS_tableWidget.horizontalHeader().setMaximumSectionSize(87)
        ...
        self.STATUS_tableWidget.verticalHeader().setMinimumSectionSize(28)
        self.STATUS_tableWidget.verticalHeader().setMaximumSectionSize(28)
...
"DAQ"))
        ...
        item.setText(_translate("gui", "SENS_COFF_A_S2"))
        ...
        item.setText(_translate("gui", "FLOW_S2"))
        ...
        item.setText(_translate("gui", "RTD_S4"))
    ...
    def comUpdate(self):
        try:    
            #minimalmodbus._print_out(f"Port: {args.port}, Address: {args.adr}")
            self.instr = minimalmodbus.Instrument(args.port, args.adr)
    ...
    def set_pour(self,pour_button,addr):
        if pour_button.text()=="":
            pour_button.setText("0")
            self.setRH(addr,0.0,"Float")
        
        elif float(pour_button.text())==0.0 :
            pour_button.setText("0.75")
            self.setRH(addr,0.75,"Float")

        elif float(pour_button.text())==0.75 :
            pour_button.setText("1")
            self.setRH(addr,1.0,"Float")

        elif float(pour_button.text())==1.0 :
            pour_button.setText("1.5")
            self.setRH(addr,1.5,"Float")

        elif float(pour_button.text())==1.5 :
            pour_button.setText("2")
            self.setRH(addr,2.0,"Float")

        elif float(pour_button.text())==2.0 :
            pour_button.setText("3")
            self.setRH(addr,3.0,"Float")

        elif float(pour_button.text())==3.0 :
            pour_button.setText("0")
            self.setRH(addr,0.0,"Float")
